        ...
        <nav class="navbar navbar-expand-lg navbar-light"  >
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item">
                  <a class="nav-link" style ="color: white;" href="about_iitu">About IITU</a>
                </li>
                ...
                <li class="nav-item dropdown">
                  ...
                  <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                    ...
                    <a class="dropdown-item" href="achiev">Achievements of students </a>
                    <a class="dropdown-item" href="schedule">Schedule </a>
                    <a class="dropdown-item" href="organizations">Organisations </a>
                    <div class="dropdown-divider"></div>
                    <a class="dropdown-item" href="userFaq">FAQ</a>
                  </div>
                </li>
                <li class="nav-item">
