  ...
  <body>
    ...
    <header class="header_intro">
      ...
      <div class="my_container">            
            ...
            <a href="/profile" style="color: white;text-align: right;">{{session()->get('user')->email}}</a>
            @endif
            @if(session()->get('user')!=null)
            <a href="/logout" style="color: white;text-align: right;">Logout</a>
            @endif
            @if(session()->get('user')==null)
    ...
    <div class="my_container">
            <div class="title_events">
                @if(count($user_orgs)>0)
                    <h5 class="display-4">My Organizations</h5>
                @else
                    <h5 class="display-4">You don`t have organizations</h5>
                        ...
                        <div class="modal-content">
                          ...
                          <form action="create_organization" method="post">
                            ...
                            <div class="modal-body">
                              ...
                              <div class="form-group">
                                <label>Limit of Amount Users:</label>
                                <input name="amount_users" type="number" class="form-control" required>
                              </div>                           
                            </div>
            ...
            <div class="card-deck">
                ...
                <div class="card-body">
                    <h5 class="card-title"><a href="requests">{{$o->name}}</a></h5>
        ...
        <div class="my_container">
            <div class="title_events">
                <h5 class="display-4">All Organizations</h5>
            </div>
            <div class="card-deck">
                @foreach($orgs as $o)
                <div class="card mb-3" style="max-width:300px;min-width:250px;">
